...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-gray-900">
      ...
      {/* Floating WhatsApp Button - Custom Image Icon */}
      <a 
        href={whatsappLink}
        target="_blank" 
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 z-50 transition-transform hover:scale-110 animate-in fade-in slide-in-from-bottom-10 duration-700 shadow-2xl rounded-full overflow-hidden"
