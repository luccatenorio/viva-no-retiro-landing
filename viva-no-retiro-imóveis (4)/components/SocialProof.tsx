...
const team: TeamMember[] = [
  { id: 1, name: "Márcio Araujo", role: "Sócio Diretor", image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?q=80&w=400&auto=format&fit=crop" },
  { id: 2, name: "Josimar Braga", role: "Sócio Diretor", image: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?q=80&w=400&auto=format&fit=crop" }
];
        ...
        {testimonialImages.map((imgUrl, index) => (
          ...
          >
            <img 
              ...
              className={`w-full ${index === 2 ? 'h-auto' : 'h-full object-cover'}`}
            />
          </div>
        ))}
      </div>
